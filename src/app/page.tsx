...
function ModelCard({ model, provider, price, value, tag, tagColor, ctx, per1m }: typeof TOP_MODELS[0]) {
    ...
    <div style={{ paddingTop: '56px' }}>
      <section style={{
        ...
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'var(--fg-4)', textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: '20px' }}>
          [ REAL-TIME AI PLAN INTELLIGENCE &middot; {tick % 2 === 0 ? '47 MODELS TRACKED' : 'UPDATED DAILY'} ]
        </div>
        ...
        <h1 style={{
          ...
          Every model.<br />
          <span style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: 400, color: 'var(--fg-2)' }}>One clear</span><br />
          verdict.
        </h1>
      ...
      <div style={{ borderTop: '1px solid var(--line-1)', maxWidth: 'var(--max-w)', margin: '0 auto var(--gutter)' }} />
      ...
      <section style={{ maxWidth: 'var(--max-w)', margin: '0 auto', padding: '80px var(--gutter)', textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: 'var(--font-sans)', fontWeight: 800, fontSize: 'clamp(32px,5vw,56px)', letterSpacing: '-0.02em', color: 'var(--fg-1)', lineHeight: 0.96, marginBottom: '16px' }}>
          Stop overpaying<br />
          <span style={{ fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: 400, color: 'var(--fg-3)' }}>for AI you don&apos;t need.</span>
        </h2>
        ...
        <a href="/pricing" style={{
          ...
          display: 'inline-block',
        }}>Start comparing &mdash; it&apos;s free</a>
      </section>
    </div>
  )
}
